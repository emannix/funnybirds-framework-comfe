...
#SBATCH --mem=112G
#SBATCH --time=1:00:00
#SBATCH --output runme_dinov2s.out
#SBATCH --open-mode=truncate
#SBATCH --job-name=runme_dinov2s
...
python evaluate_explainability.py --data /data/cephfs/punim0980/data/FunnyBirds --model comfe_dinov2-vits --explainer comfe_dinov2-vits --accuracy --controlled_synthetic_data_check --target_sensitivity --single_deletion --preservation_check --deletion_check --distractibility --background_independence --gpu 0
